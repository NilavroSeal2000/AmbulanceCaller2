...
public class SignInActivityDriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e1=findViewById(R.id.email_in_driver);
        e2=findViewById(R.id.password_in_driver);
        auth=FirebaseAuth.getInstance();
        dialog = new  ProgressDialog(this);

    }
    public void signin_driver(View V)
    {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful())
                            {
                                ...
                                Intent i=new Intent(SignInActivityDriver.this,MainPageActivityDriver.class);
                                startActivity(i);
                                finish();
                            }
                            else {
